...
Esta é uma coleção curada de **878+ prompts GPT-Image-2 de alta qualidade**, padrões de uso da API e fluxos visuais reutilizáveis para geração de imagens com IA.
...
> **11 casos selecionados** — [Explorar todos os prompts de design de personagem →](cases/character.md)
