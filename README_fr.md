...
Vous y trouverez une collection organisée de **904+ prompts GPT-Image-2 de grande qualité**, de modèles d'utilisation de l'API et de workflows visuels réutilisables pour la génération d'images par IA.
...
> **148 cas selectionnes** — [Explorer tous les prompts d'affiches →](cases/poster.md)
...
> **13 cas sélectionnés** — [Explorer tous les prompts de design de personnage →](cases/character.md)
