...
Una colección curada de **904+ prompts GPT-Image-2 de alta calidad**, patrones de uso de API y flujos visuales reutilizables para generación de imágenes con IA.
...
> **13 casos seleccionados** — [Explora todos los prompts de diseño de personajes →](cases/character.md)
