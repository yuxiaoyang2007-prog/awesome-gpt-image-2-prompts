...
AI 画像生成のために厳選された **359+ の高品質な GPT-Image-2 プロンプト**、API 利用パターン、再利用可能なビジュアルワークフローのコレクションです。

GPT-Image-2 のプロンプト例、テキストから画像生成のベストプラクティス、画像編集テクニック、そのまま使えるプロンプトテンプレートを探しているなら — ここがワンストップの参考リソースです。

**ここで見つかるもの:**
- 🎯 7 カテゴリーの本番運用に耐えるプロンプト(ポートレート、ポスター、UI、Eコマース、広告クリエイティブ、キャラクターデザイン、比較)
- 🔌 GPT Image 2 API 統合ガイドと呼び出し可能な Skill
- 🌍 11 言語の完全ドキュメント
- 📸 プロンプトケースごとの実出力画像
...
**GPT Image 2**(GPT-Image-2 または gpt-image-2 とも呼ばれます)は、OpenAI の最新の画像生成・編集モデルで、ChatGPT にネイティブ統合され、OpenAI API 経由でも利用できます。

**主な機能:**
- **テキストから画像生成** — 自然言語プロンプトからフォトリアルな画像、イラスト、ポスター、UI モックアップなどを作成
- **画像編集** — テキスト指示で既存画像を編集(インペイント、アウトペイント、スタイル転送)
- **マルチターン会話** — 対話を通じて画像を反復的に洗練
- **高忠実度のテキストレンダリング** — 生成画像内の文字を正確に描画
- **一貫したキャラクター生成** — 複数生成にわたってキャラクターのアイデンティティを保持

**開発者が GPT Image 2 API を使う理由:**
- 1 つの API 呼び出しで生成と編集の両方
- 旧モデル比で優れたプロンプト追従性
- アスペクト比、透過、バッチ生成のネイティブサポート
- OpenAI 標準 API 形式(`/v1/images/generations`)で動作

> API の使い方の詳細は下記の [Use GPT Image 2 API](#-use-gpt-image-2-api) セクションを参照してください。
...
<!-- Case 139: ドリンクを持つ陽気なストリートポートレート (by @rovvmut_) -->
### Case 139: [ドリンクを持つ陽気なストリートポートレート](https://twitter.com/rovvmut_/status/2056786034864927229) (by [@rovvmut_](https://x.com/rovvmut_))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case199/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - ドリンクを持つ陽気なストリートポートレート"></a> |
...
<!-- Case 140: フィルムストリップ風ポートレートコラージュポスター (by @robertsmith_ai) -->
### Case 140: [フィルムストリップ風ポートレートコラージュポスター](https://twitter.com/robertsmith_ai/status/2056766784846606727) (by [@robertsmith_ai](https://x.com/robertsmith_ai))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case200/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - フィルムストリップ風ポートレートコラージュポスター"></a> |
...
<!-- Case 141: 参照画像ベースのポートレート一貫性 (by @mehvishs25) -->
### Case 141: [参照画像ベースのポートレート一貫性](https://twitter.com/mehvishs25/status/2056770900125790595) (by [@mehvishs25](https://x.com/mehvishs25))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case201/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 参照画像ベースのポートレート一貫性"></a> |
...
<!-- Case 142: ロンドンのファッションストリートポートレート (by @ShamiWeb3) -->
### Case 142: [ロンドンのファッションストリートポートレート](https://twitter.com/ShamiWeb3/status/2056904361792716894) (by [@ShamiWeb3](https://x.com/ShamiWeb3))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case202/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - ロンドンのファッションストリートポートレート"></a> |
...
<!-- Case 143: 旅行セルフィーポートレート参照 (by @linaa_ai) -->
### Case 143: [旅行セルフィーポートレート参照](https://twitter.com/linaa_ai/status/2056777746265858158) (by [@linaa_ai](https://x.com/linaa_ai))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case203/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 旅行セルフィーポートレート参照"></a> |
...
<!-- Case 144: 超写実的なスマホ風ポートレート (by @AiwithZohaib) -->
### Case 144: [超写実的なスマホ風ポートレート](https://twitter.com/AiwithZohaib/status/2056835104824312018) (by [@AiwithZohaib](https://x.com/AiwithZohaib))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case204/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 超写実的なスマホ風ポートレート"></a> |
...
<!-- Case 145: 木版画風エングレービングポートレート (by @zulkarnaimx) -->
### Case 145: [木版画風エングレービングポートレート](https://twitter.com/zulkarnaimx/status/2056778953273258275) (by [@zulkarnaimx](https://x.com/zulkarnaimx))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case205/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 木版画風エングレービングポートレート"></a> |
...
<!-- Case 146: Pixar風3Dキャラクターデザインシート (by @TechieBySA) -->
### Case 146: [Pixar風3Dキャラクターデザインシート](https://twitter.com/TechieBySA/status/2056784334628036676) (by [@TechieBySA](https://x.com/TechieBySA))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case206/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - Pixar風3Dキャラクターデザインシート"></a> |
...
<!-- Case 147: 抹茶の女神ビューティーポートレート (by @NyaiiBubu) -->
### Case 147: [抹茶の女神ビューティーポートレート](https://twitter.com/NyaiiBubu/status/2056817669668737442) (by [@NyaiiBubu](https://x.com/NyaiiBubu))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case207/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 抹茶の女神ビューティーポートレート"></a> |
...
<!-- Case 148: ヴィンテージカメラLCDスクリーンショット (by @ZaraElira4) -->
### Case 148: [ヴィンテージカメラLCDスクリーンショット](https://twitter.com/ZaraElira4/status/2056786815978524772) (by [@ZaraElira4](https://x.com/ZaraElira4))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case208/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - ヴィンテージカメラLCDスクリーンショット"></a> |
...
<!-- Case 223: 1960年代ヴィンテージビール広告ポスター (by @Goodmanprotocol) -->
### Case 223: [1960年代ヴィンテージビール広告ポスター](https://twitter.com/Goodmanprotocol/status/2056791983717503015) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case293/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 1960年代ヴィンテージビール広告ポスター"></a> |
...
<!-- Case 224: シネマティックな監督向けピッチボード (by @Mind_Boticni) -->
### Case 224: [シネマティックな監督向けピッチボード](https://twitter.com/Mind_Boticni/status/2056793598243553464) (by [@Mind_Boticni](https://x.com/Mind_Boticni))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case294/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - シネマティックな監督向けピッチボード"></a> |
...
<!-- Case 225: バズるフードインフォグラフィックポスター (by @amynys) -->
### Case 225: [バズるフードインフォグラフィックポスター](https://twitter.com/amynys/status/2056779657987387784) (by [@amynys](https://x.com/amynys))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case295/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - バズるフードインフォグラフィックポスター"></a> |
...
<!-- Case 226: 2x2 ラグジュアリー3D彫刻ポスター (by @Gdgtify) -->
### Case 226: [2x2 ラグジュアリー3D彫刻ポスター](https://twitter.com/Gdgtify/status/2056649309312160193) (by [@Gdgtify](https://x.com/Gdgtify))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case296/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 2x2 ラグジュアリー3D彫刻ポスター"></a> |
...
<!-- Case 227: 物理インフォグラフィック用コードプロンプト (by @Gdgtify) -->
### Case 227: [物理インフォグラフィック用コードプロンプト](https://twitter.com/Gdgtify/status/2056841574798295540) (by [@Gdgtify](https://x.com/Gdgtify))

| 出力 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case297/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 物理インフォグラフィック用コードプロンプト"></a> |
...
コミュニティからの貢献を歓迎します! 素晴らしい GPT-Image-2 プロンプトを作成・発見した場合は、ぜひコミュニティと共有してください。

**貢献方法:**

1. **Issue でプロンプトを投稿する** — [プロンプト投稿テンプレート](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml) を使って、出力画像と一緒にプロンプトを投稿
2. **Pull Request を開く** — 既存のフォーマットに従って、適切な `cases/*.md` ファイルに直接ケースを追加
3. **問題を報告する** — リンク切れやプロンプトの誤りを見つけたら [issue を開いてください](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new)

**投稿ガイドライン:**
- 完全で再利用可能なプロンプトテキストを含める(説明だけはダメ)
- 出力画像を 1 枚以上添付またはリンクする
- プロンプトがどのカテゴリーに属するかを指定する
- 他者の作品を共有する場合は元の作者をクレジットする
