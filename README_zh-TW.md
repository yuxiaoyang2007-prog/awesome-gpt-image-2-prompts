...
精選 **359+ 高品質 GPT-Image-2 提示詞**、API 使用模式和可複用的視覺工作流，用於 AI 圖像生成。

無論你在尋找 GPT-Image-2 提示詞範例、文生圖最佳實踐、圖像編輯技巧還是即用型提示詞模板——這裡是你的一站式參考。

**你將在這裡找到：**
- 🎯 覆蓋 7 個類別的生產級提示詞（人像、海報、UI、電商、廣告創意、角色設計、對比）
- 🔌 GPT Image 2 API 整合指南和可呼叫 Skill
- 🌍 11 種語言的完整文件
- 📸 每個提示詞案例的真實輸出圖片
...
**GPT Image 2**（也稱為 GPT-Image-2 或 gpt-image-2）是 OpenAI 最新的圖像生成和編輯模型，原生整合在 ChatGPT 中，並透過 OpenAI API 提供。

**核心能力：**
- **文生圖** — 從自然語言提示詞建立逼真照片、插畫、海報、UI 原型等
- **圖像編輯** — 用文字指令修改現有圖像（局部重繪、擴展、風格遷移）
- **多輪對話** — 透過對話迭代優化圖像
- **高保真文字渲染** — 在生成圖像中精確渲染文字
- **一致性角色生成** — 在多次生成中保持角色身份一致

**開發者使用 GPT Image 2 API 的原因：**
- 一次 API 呼叫同時支援生成和編輯
- 相比前代模型，提示詞遵循度更高
- 原生支援寬高比、透明度和批量生成
...
<!-- Case 139: 手持飲料的街頭歡樂人像 (by @rovvmut_) -->
### Case 139: [手持飲料的街頭歡樂人像](https://twitter.com/rovvmut_/status/2056786034864927229) (by [@rovvmut_](https://x.com/rovvmut_))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case199/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 手持飲料的街頭歡樂人像"></a> |
...
<!-- Case 140: 膠片拼貼人像海報 (by @robertsmith_ai) -->
### Case 140: [膠片拼貼人像海報](https://twitter.com/robertsmith_ai/status/2056766784846606727) (by [@robertsmith_ai](https://x.com/robertsmith_ai))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case200/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 膠片拼貼人像海報"></a> |
...
<!-- Case 141: 基於參考圖的人像一致性 (by @mehvishs25) -->
### Case 141: [基於參考圖的人像一致性](https://twitter.com/mehvishs25/status/2056770900125790595) (by [@mehvishs25](https://x.com/mehvishs25))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case201/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 基於參考圖的人像一致性"></a> |
...
<!-- Case 142: 倫敦時尚街頭人像 (by @ShamiWeb3) -->
### Case 142: [倫敦時尚街頭人像](https://twitter.com/ShamiWeb3/status/2056904361792716894) (by [@ShamiWeb3](https://x.com/ShamiWeb3))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case202/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 倫敦時尚街頭人像"></a> |
...
<!-- Case 143: 旅行自拍人像參考 (by @linaa_ai) -->
### Case 143: [旅行自拍人像參考](https://twitter.com/linaa_ai/status/2056777746265858158) (by [@linaa_ai](https://x.com/linaa_ai))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case203/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 旅行自拍人像參考"></a> |
...
<!-- Case 144: 超寫實手機風格人像 (by @AiwithZohaib) -->
### Case 144: [超寫實手機風格人像](https://twitter.com/AiwithZohaib/status/2056835104824312018) (by [@AiwithZohaib](https://x.com/AiwithZohaib))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case204/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 超寫實手機風格人像"></a> |
...
<!-- Case 145: 木刻版畫人像風格 (by @zulkarnaimx) -->
### Case 145: [木刻版畫人像風格](https://twitter.com/zulkarnaimx/status/2056778953273258275) (by [@zulkarnaimx](https://x.com/zulkarnaimx))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case205/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 木刻版畫人像風格"></a> |
...
<!-- Case 146: 皮克斯風 3D 角色設計表 (by @TechieBySA) -->
### Case 146: [皮克斯風 3D 角色設計表](https://twitter.com/TechieBySA/status/2056784334628036676) (by [@TechieBySA](https://x.com/TechieBySA))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case206/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 皮克斯風 3D 角色設計表"></a> |
...
<!-- Case 147: 抹茶女神美妝人像 (by @NyaiiBubu) -->
### Case 147: [抹茶女神美妝人像](https://twitter.com/NyaiiBubu/status/2056817669668737442) (by [@NyaiiBubu](https://x.com/NyaiiBubu))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case207/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 抹茶女神美妝人像"></a> |
...
<!-- Case 148: 復古相機 LCD 螢幕截圖 (by @ZaraElira4) -->
### Case 148: [復古相機 LCD 螢幕截圖](https://twitter.com/ZaraElira4/status/2056786815978524772) (by [@ZaraElira4](https://x.com/ZaraElira4))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case208/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 復古相機 LCD 螢幕截圖"></a> |
...
<!-- Case 223: 復古 1960 年代啤酒廣告海報 (by @Goodmanprotocol) -->
### Case 223: [復古 1960 年代啤酒廣告海報](https://twitter.com/Goodmanprotocol/status/2056791983717503015) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case293/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 復古 1960 年代啤酒廣告海報"></a> |
...
<!-- Case 224: 電影導演提案板 (by @Mind_Boticni) -->
### Case 224: [電影導演提案板](https://twitter.com/Mind_Boticni/status/2056793598243553464) (by [@Mind_Boticni](https://x.com/Mind_Boticni))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case294/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 電影導演提案板"></a> |
...
<!-- Case 225: 爆款美食資訊圖海報 (by @amynys) -->
### Case 225: [爆款美食資訊圖海報](https://twitter.com/amynys/status/2056779657987387784) (by [@amynys](https://x.com/amynys))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case295/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 爆款美食資訊圖海報"></a> |
...
<!-- Case 226: 2x2 奢華 3D 雕塑海報 (by @Gdgtify) -->
### Case 226: [2x2 奢華 3D 雕塑海報](https://twitter.com/Gdgtify/status/2056649309312160193) (by [@Gdgtify](https://x.com/Gdgtify))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case296/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 2x2 奢華 3D 雕塑海報"></a> |
...
<!-- Case 227: 物理資訊圖程式提示詞 (by @Gdgtify) -->
### Case 227: [物理資訊圖程式提示詞](https://twitter.com/Gdgtify/status/2056841574798295540) (by [@Gdgtify](https://x.com/Gdgtify))

| 輸出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case297/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 物理資訊圖程式提示詞"></a> |
...
歡迎社區貢獻！如果你建立或發現了優秀的 GPT-Image-2 提示詞，請與社區分享。

**貢獻方式：**

1. **透過 Issue 提交提示詞** — 使用我們的[提示詞提交模板](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml)提交你的提示詞和輸出圖片
2. **提交 Pull Request** — 按照現有格式直接將你的案例新增到對應的 `cases/*.md` 檔案
3. **回報問題** — 發現了失效連結或錯誤提示詞？[提交 Issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new)

**提交指南：**
- 包含完整、可複用的提示詞文本（不僅僅是描述）
- 附上或連結至少一張輸出圖片
- 指明你的提示詞屬於哪個類別
- 如果分享他人作品請註明原作者
