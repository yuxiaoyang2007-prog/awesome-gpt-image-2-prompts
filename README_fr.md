...
Vous y trouverez une collection organisée de **871+ prompts GPT-Image-2 de grande qualité**, de modèles d'utilisation de l'API et de workflows visuels réutilisables pour la génération d'images par IA.
...
> **21 cas sélectionnés** — [Explorer tous les prompts de création publicitaire →](cases/ad-creative.md)
...
> **123 cas organisés** — [Explorer tous les prompts portrait →](cases/portrait.md)
...
> **142 cas sélectionnés** — [Explorer tous les prompts d’affiches →](cases/poster.md)
...
> **9 cas sélectionnés** — [Explorer tous les prompts de design de personnage →](cases/character.md)
...
> **36 cas sélectionnés** — [Explorer tous les prompts UI et mockup →](cases/ui.md)
