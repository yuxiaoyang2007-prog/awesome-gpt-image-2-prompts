...
Vous y trouverez une collection organisée de **911+ prompts GPT-Image-2 de grande qualité**, de modèles d'utilisation de l'API et de workflows visuels réutilisables pour la génération d'images par IA.
...
> **129 cas organises** — [Explorer tous les prompts portrait →](cases/portrait.md)
...
> **150 cas selectionnes** — [Explorer tous les prompts d'affiches →](cases/poster.md)
...
> **14 cas sélectionnés** — [Explorer tous les prompts de design de personnage →](cases/character.md)
...
> **41 cas selectionnes** — [Explorer tous les prompts UI et mockup →](cases/ui.md)
