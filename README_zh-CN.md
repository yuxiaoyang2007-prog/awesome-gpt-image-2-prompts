...
精选 **359+ 高质量 GPT-Image-2 提示词**、API 使用模式和可复用的视觉工作流，用于 AI 图像生成。

无论你在寻找 GPT-Image-2 提示词示例、文生图最佳实践、图像编辑技巧还是即用型提示词模板——这里是你的一站式参考。

**你将在这里找到：**
- 🎯 覆盖 7 个类别的生产级提示词（人像、海报、UI、电商、广告创意、角色设计、对比）
- 🔌 GPT Image 2 API 集成指南和可调用 Skill
- 🌍 11 种语言的完整文档
- 📸 每个提示词案例的真实输出图片
...
**GPT Image 2**（也称为 GPT-Image-2 或 gpt-image-2）是 OpenAI 最新的图像生成和编辑模型，原生集成在 ChatGPT 中，并通过 OpenAI API 提供。

**核心能力：**
- **文生图** — 从自然语言提示词创建逼真照片、插画、海报、UI 原型等
- **图像编辑** — 用文字指令修改现有图像（局部重绘、扩展、风格迁移）
- **多轮对话** — 通过对话迭代优化图像
- **高保真文字渲染** — 在生成图像中精确渲染文字
- **一致性角色生成** — 在多次生成中保持角色身份一致

**开发者使用 GPT Image 2 API 的原因：**
- 一次 API 调用同时支持生成和编辑
- 相比前代模型，提示词遵循度更高
- 原生支持宽高比、透明度和批量生成
...
<!-- Case 139: 手持饮料的街头欢乐人像 (by @rovvmut_) -->
### Case 139: [手持饮料的街头欢乐人像](https://twitter.com/rovvmut_/status/2056786034864927229) (by [@rovvmut_](https://x.com/rovvmut_))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case199/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 手持饮料的街头欢乐人像"></a> |
...
<!-- Case 140: 胶片拼贴人像海报 (by @robertsmith_ai) -->
### Case 140: [胶片拼贴人像海报](https://twitter.com/robertsmith_ai/status/2056766784846606727) (by [@robertsmith_ai](https://x.com/robertsmith_ai))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case200/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 胶片拼贴人像海报"></a> |
...
<!-- Case 141: 基于参考图的人像一致性 (by @mehvishs25) -->
### Case 141: [基于参考图的人像一致性](https://twitter.com/mehvishs25/status/2056770900125790595) (by [@mehvishs25](https://x.com/mehvishs25))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case201/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 基于参考图的人像一致性"></a> |
...
<!-- Case 142: 伦敦时尚街头人像 (by @ShamiWeb3) -->
### Case 142: [伦敦时尚街头人像](https://twitter.com/ShamiWeb3/status/2056904361792716894) (by [@ShamiWeb3](https://x.com/ShamiWeb3))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case202/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 伦敦时尚街头人像"></a> |
...
<!-- Case 143: 旅行自拍人像参考 (by @linaa_ai) -->
### Case 143: [旅行自拍人像参考](https://twitter.com/linaa_ai/status/2056777746265858158) (by [@linaa_ai](https://x.com/linaa_ai))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case203/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 旅行自拍人像参考"></a> |
...
<!-- Case 144: 超写实手机风格人像 (by @AiwithZohaib) -->
### Case 144: [超写实手机风格人像](https://twitter.com/AiwithZohaib/status/2056835104824312018) (by [@AiwithZohaib](https://x.com/AiwithZohaib))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case204/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 超写实手机风格人像"></a> |
...
<!-- Case 145: 木刻版画人像风格 (by @zulkarnaimx) -->
### Case 145: [木刻版画人像风格](https://twitter.com/zulkarnaimx/status/2056778953273258275) (by [@zulkarnaimx](https://x.com/zulkarnaimx))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case205/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 木刻版画人像风格"></a> |
...
<!-- Case 146: 皮克斯风 3D 角色设计表 (by @TechieBySA) -->
### Case 146: [皮克斯风 3D 角色设计表](https://twitter.com/TechieBySA/status/2056784334628036676) (by [@TechieBySA](https://x.com/TechieBySA))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case206/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 皮克斯风 3D 角色设计表"></a> |
...
<!-- Case 147: 抹茶女神美妆人像 (by @NyaiiBubu) -->
### Case 147: [抹茶女神美妆人像](https://twitter.com/NyaiiBubu/status/2056817669668737442) (by [@NyaiiBubu](https://x.com/NyaiiBubu))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case207/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 抹茶女神美妆人像"></a> |
...
<!-- Case 148: 复古相机 LCD 屏幕截图 (by @ZaraElira4) -->
### Case 148: [复古相机 LCD 屏幕截图](https://twitter.com/ZaraElira4/status/2056786815978524772) (by [@ZaraElira4](https://x.com/ZaraElira4))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/portrait_case208/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 复古相机 LCD 屏幕截图"></a> |
...
<!-- Case 223: 复古1960年代啤酒广告海报 (by @Goodmanprotocol) -->
### Case 223: [复古1960年代啤酒广告海报](https://twitter.com/Goodmanprotocol/status/2056791983717503015) (by [@Goodmanprotocol](https://x.com/Goodmanprotocol))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case293/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 复古1960年代啤酒广告海报"></a> |
...
<!-- Case 224: 电影导演提案板 (by @Mind_Boticni) -->
### Case 224: [电影导演提案板](https://twitter.com/Mind_Boticni/status/2056793598243553464) (by [@Mind_Boticni](https://x.com/Mind_Boticni))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case294/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 电影导演提案板"></a> |
...
<!-- Case 225: 爆款美食信息图海报 (by @amynys) -->
### Case 225: [爆款美食信息图海报](https://twitter.com/amynys/status/2056779657987387784) (by [@amynys](https://x.com/amynys))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case295/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 爆款美食信息图海报"></a> |
...
<!-- Case 226: 2x2 奢华 3D 雕塑海报 (by @Gdgtify) -->
### Case 226: [2x2 奢华 3D 雕塑海报](https://twitter.com/Gdgtify/status/2056649309312160193) (by [@Gdgtify](https://x.com/Gdgtify))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case296/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 2x2 奢华 3D 雕塑海报"></a> |
...
<!-- Case 227: 物理信息图代码提示词 (by @Gdgtify) -->
### Case 227: [物理信息图代码提示词](https://twitter.com/Gdgtify/status/2056841574798295540) (by [@Gdgtify](https://x.com/Gdgtify))

| 输出 |
| :----: |
| <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-prompts" target="_blank" rel="noopener noreferrer"><img src="https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/poster_case297/output.jpg" width="300" alt="GPT-Image-2 Prompt Example - 物理信息图代码提示词"></a> |
...
欢迎社区贡献！如果你创建或发现了优秀的 GPT-Image-2 提示词，请与社区分享。

**贡献方式：**

1. **通过 Issue 提交提示词** — 使用我们的[提示词提交模板](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new?template=submit-prompt.yml)提交你的提示词和输出图片
2. **提交 Pull Request** — 按照现有格式直接将你的案例添加到对应的 `cases/*.md` 文件
3. **报告问题** — 发现了失效链接或错误提示词？[提交 Issue](https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/issues/new)

**提交指南：**
- 包含完整、可复用的提示词文本（不仅仅是描述）
- 附上或链接至少一张输出图片
- 指明你的提示词属于哪个类别
- 如果分享他人作品请注明原作者
