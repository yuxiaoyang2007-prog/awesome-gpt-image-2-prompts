...
<p align="center">
  <a href="https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Page du modèle</strong></a> &nbsp;·&nbsp;
  <a href="https://docs.evolink.ai/en/api-manual/image-series/gpt-image-2/gpt-image-2-image-generation?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Documentation</strong></a> &nbsp;·&nbsp;
  <a href="https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts"><strong>Clé API</strong></a> &nbsp;·&nbsp;
...
Vous y trouverez une collection organisée de **878+ prompts GPT-Image-2 de grande qualité**, de modèles d'utilisation de l'API et de workflows visuels réutilisables pour la génération d'images par IA.
...
Essayez-le sur Evolink : [API GPT-Image-2](https://evolink.ai/gpt-image-2-prompts?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
...
- [Obtenir votre clé API](https://evolink.ai/dashboard?utm_source=github&utm_medium=readme&utm_campaign=awesome-gpt-image-2-API-and-Prompts)
- Lire la documentation de l'API GPT Image 2
...
> **11 cas sélectionnés** — [Explorer tous les prompts de design de personnage →](cases/character.md)
...
👉 **Voir les 13 cas de prompts de design de personnage →**
...
> **24 cas sélectionnés** — [Explorer tous les exemples de comparaison →](cases/comparison.md)
...
👉 **Voir les 53 cas de prompts de comparaison et exemples communautaires →**
