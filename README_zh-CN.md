...
精选收录 **871+ 个高质量 GPT-Image-2 提示词**、API 使用模式与可复用视觉工作流，面向 AI 图像生成实践。
...
> **21 个精选案例** — [浏览全部广告创意提示词 →](cases/ad-creative.md)
...
> **142 个精选案例** — [浏览全部海报提示词 →](cases/poster.md)
...
> **9 个精选案例** — [浏览全部角色设计提示词 →](cases/character.md)
...
> **36 个精选案例** — [浏览全部 UI 与 Mockup 提示词 →](cases/ui.md)
