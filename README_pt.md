...
Esta é uma coleção curada de **871+ prompts GPT-Image-2 de alta qualidade**, padrões de uso da API e fluxos visuais reutilizáveis para geração de imagens com IA.
...
> **21 casos selecionados** — [Explorar todos os prompts de criativos publicitários →](cases/ad-creative.md)
...
> **123 casos curados** — [Explore todos os prompts de retrato →](cases/portrait.md)
...
> **142 casos selecionados** — [Explorar todos os prompts de pôster →](cases/poster.md)
...
> **9 casos selecionados** — [Explorar todos os prompts de design de personagem →](cases/character.md)
...
👉 **Veja os 13 casos de prompts de design de personagem →**
...
> **36 casos selecionados** — [Explorar todos os prompts de UI e mockup →](cases/ui.md)
...
> **24 casos selecionados** — [Explorar todos os exemplos de comparação →](cases/comparison.md)
...
👉 **Veja os 53 casos de prompts de comparação e exemplos da comunidade →**
