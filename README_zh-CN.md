...
精选收录 **911+ 个高质量 GPT-Image-2 提示词**、API 使用模式与可复用视觉工作流，面向 AI 图像生成实践。
...
> **129 个精选案例** — [浏览全部人像与摄影提示词 →](cases/portrait.md)
...
> **150 个精选案例** — [浏览全部海报与插画提示词 →](cases/poster.md)
...
> **14 个精选案例** — [浏览全部角色设计提示词 →](cases/character.md)
...
> **41 个精选案例** — [浏览全部 UI 与社交媒体截图提示词 →](cases/ui.md)
