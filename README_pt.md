...
Esta é uma coleção curada de **911+ prompts GPT-Image-2 de alta qualidade**, padrões de uso da API e fluxos visuais reutilizáveis para geração de imagens com IA.
...
> **129 casos curados** — [Explore todos os prompts de retrato →](cases/portrait.md)
...
> **150 casos selecionados** — [Explorar todos os prompts de pôster →](cases/poster.md)
...
> **14 casos selecionados** — [Explorar todos os prompts de design de personagem →](cases/character.md)
...
### Case 29: [Companheiros animais kawaii em tons pastel](https://x.com/Taaruk_/status/2068351521016955098) (by [@Taaruk_](https://x.com/Taaruk_))
...
> **27 casos selecionados** — [Explorar todos os exemplos de comparação →](cases/comparison.md)
