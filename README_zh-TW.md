...
精選收錄 **911+ 個高品質 GPT-Image-2 提示詞**、API 使用模式與可重用視覺工作流，面向 AI 圖像生成實作。
...
> **129 個精選案例** — [瀏覽全部人像與攝影提示詞 →](cases/portrait.md)
...
> **150 個精選案例** — [瀏覽全部海報提示詞 →](cases/poster.md)
...
> **14 個精選案例** — [瀏覽全部角色設計提示詞 →](cases/character.md)
...
> **41 個精選案例** — [瀏覽全部 UI 與社群媒體 Mockup 提示詞 →](cases/ui.md)
